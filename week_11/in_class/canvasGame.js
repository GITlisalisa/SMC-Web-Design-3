...
// // function to change ball velocity when ball is clicked 
// canvas2.addEventListener("onmousedown", function(event){
//     //console.log(event);
...
// // function to change ball color when colorRand button is clicked 
